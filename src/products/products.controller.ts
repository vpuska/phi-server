...
export class ProductsController {
    ...
    @ApiOperation({
        ...
        description: 'Return a simple record identified by its product code.  The product code ' +
    ...
    @ApiOperation({
        ...
        description: 'Return a list of hospital and general medical services and provides a mapping between the mnemonics' +
    ...
    @ApiOperation({
        ...
        description: 'Filters products matching the search criteria.<br>' +
